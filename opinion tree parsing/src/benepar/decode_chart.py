...
#     print("before collapse_unary")
#     print(collapsed_tree)
    
    collapsed_tree.collapse_unary(collapsePOS=True, joinChar="::")########################################################v
    
    # print("after collapse_unary")
    # print(collapsed_tree)
...
def get_labeled_spans(tree):
    ...
    """
    # print("before collapse_unary_strip_pos")
    # print(tree)
    
    tree = collapse_unary_strip_pos(tree)
    
#     print("after collapse_unary_strip_pos")
#     print(tree)
...
class ChartDecoder:
    ...
    def tree_from_scores(self, scores, leaves):
        ...
        print("before uncollapse_unary")
        print(tree)
        tree = uncollapse_unary(tree)
        
        print("after uncollapse_unary")
        print(tree)
        return tree
